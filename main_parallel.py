...
example_path = "examples/u_example_5x5.txt"
...
if __name__ == "__main__":
    ...
    u_star2, u_est2, samples_u2 = run_mh_parameter_inference_parallel(random_state=123, u_txt_path=example_path)
    t3 = time.perf_counter()
    time_parallel = t3 - t2

    print("\n MH Parameter Inference (Original vs Parallel) \n")
